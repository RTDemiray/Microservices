        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                new Client
                {
                    ...
                    ClientSecrets = {new Secret("secret key identity".Sha512())},
                ...
                new Client
                {
                    ...
                    AllowedScopes = {"basket_fullpermission","gateway_fullpermission","order_fullpermission",IdentityServerConstants.StandardScopes.Email,IdentityServerConstants.StandardScopes.OpenId,
